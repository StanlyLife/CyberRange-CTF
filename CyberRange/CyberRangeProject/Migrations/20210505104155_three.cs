        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegistrationCodeUsed = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsTeamGame = table.Column<bool>(type: "bit", nullable: false),
                    IsPlayerGame = table.Column<bool>(type: "bit", nullable: false),
                    AlwaysOpen = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameTask", x => x.GameTaskId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    state = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ToolVmIdentifier = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ToolVmIp = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ToolVmCreated = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RandomFlag = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VirtualMachines_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PlayerTaskId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GameId = table.Column<int>(type: "int", nullable: false),
                    TaskId = table.Column<int>(type: "int", nullable: false),
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ...
                    PointsRecieved = table.Column<int>(type: "int", nullable: false),
                    NumberOfFailedflags = table.Column<int>(type: "int", nullable: false),
                    Started = table.Column<DateTime>(type: "datetime2", nullable: false),
                    VmName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VmIsRunning = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlayerTask", x => x.PlayerTaskId);
                    table.ForeignKey(
                        name: "FK_PlayerTask_AspNetUsers_Id",
                        column: x => x.Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlayerTask_Game_GameId",
                        column: x => x.GameId,
                        principalTable: "Game",
                        principalColumn: "GameId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlayerTask_Task_TaskId",
                        column: x => x.TaskId,
                        principalTable: "Task",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlayerTask_GameId",
                table: "PlayerTask",
                column: "GameId");

            migrationBuilder.CreateIndex(
                name: "IX_PlayerTask_Id",
                table: "PlayerTask",
                column: "Id");

            migrationBuilder.CreateIndex(
                name: "IX_PlayerTask_TaskId",
                table: "PlayerTask",
                column: "TaskId");

            migrationBuilder.CreateIndex(
                name: "IX_VirtualMachines_UserId",
